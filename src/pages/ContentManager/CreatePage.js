  ...
  const handleChange = (e) => {
    ...
    if (name === "original_price" || name === "discount_price") {
      ...
      const discount_price =
        name === "discount_price" ? value : formData.discount_price;

      if (
        original_price &&
        discount_price &&
        parseFloat(discount_price) >= parseFloat(original_price)
      ) {
        setFormErrors({
          ...formErrors,
  ...
  return (
    <div className="antialiased bg-orange-50 w-full min-h-screen relative py-4">
      <div className="grid grid-cols-12 mx-auto gap-2 sm:gap-4 md:gap-6 lg:gap-10 xl:gap-14 max-w-7xl my-10 px-2">
        ...
        <div
          id="content"
          className="bg-black/10 col-span-9 rounded-lg p-6"
        >
          <div className="bg-white/15 flex items-center justify-center py-12">
            <div className="mx-auto w-full max-w-[1180px]">
              ...
              <div className={"flex justify-between"}>
                {/* --- GIAO DIỆN NHẬP LINK ẢNH MỚI --- */}
                <div className="flex flex-col items-center space-y-4 border border-gray-200 rounded-lg shadow-md max-w-md mx-auto bg-white p-6 w-full">
                  <label
                    htmlFor="image"
                    className="block text-base font-medium text-gray-800 mt-2"
                  >
                    Đường link ảnh khóa học (URL)
                  </label>
                ...
                {/* <div className="flex flex-col items-center space-y-4 border border-gray-200 rounded-lg shadow-md max-w-md mx-auto bg-white">
                  ...
                  <div className="flex w-full p-1 items-center justify-center bg-grey-lighter">
                    <label className="w-64 flex flex-col items-center px-2 py-3 bg-white text-blue rounded-lg shadow-lg tracking-wide uppercase border border-blue cursor-pointer hover:bg-blue hover:text-white">
                      <svg
                        className="w-8 h-8"
                        fill="currentColor"
                ...
                <div>
                  ...
                  >
                    ...
                    <div className={" text-center"}>
                      <button className="mt-5 rounded-xl hover:shadow-formrounded-md bg-[#6A64F1] py-3 px-8 text-base font-semibold text-white outline-none">
                        Tạo khóa học
                      </button>
      ...
      {isModalOpen && (
        <CategoryModal closeModal={() => setIsModalOpen(false)} />
      )}{" "}
